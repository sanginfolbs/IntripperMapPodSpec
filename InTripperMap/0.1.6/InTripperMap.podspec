...
5.	Trigger proximity alerts at geo-fenced zones.
  ...
  # Or just: s.author    = "Shweta"
  # s.authors            = { "Shweta" => "you@yourdomain.com" }
  # s.social_media_url   = "http://twitter.com/Shweta"
  ...
  s.source       = { :git => "https://github.com/sanginfolbs/IntripperMap.git", :tag => "0.1.6" }
